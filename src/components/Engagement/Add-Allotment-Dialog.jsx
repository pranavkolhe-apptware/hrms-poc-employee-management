...
//     projects, 
//     employees, 
//     // Note: We'll not use the deployedEmployees from the hook here.
//     loading, 
//     error 
//   } = useProjectsAndEmployees(open);
...
//   // Fetch deployed employees for the chosen project when engagementStatus is 'SHADOW'
//   useEffect(() => {
//     const fetchShadowCandidates = async () => {
//       if (formData.projectId && formData.engagementStatus === 'SHADOW') {
//         try {
...
//           );
//           if (!res.ok) {
//             throw new Error('Failed to fetch deployed employees for project');
//           }
...
//       if (!response.ok) {
//         toast.error('Failed to add allotment');
//         throw new Error('Failed to add allotment');
//       }

//       console.log("Payload", JSON.stringify(payload));

//       // toast with the given data to api
//         toast.success('Allotment added successfully');
